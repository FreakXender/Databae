...
USE bincom_test;  -- Change 'bincom_test' to your actual database name
SELECT polling_unit_id, polling_unit_name FROM polling_unit LIMIT 10;

SELECT lga_id, lga_name FROM lga LIMIT 10;

SELECT * FROM lga WHERE lga_id = 13;

SELECT polling_unit_id, polling_unit_name 
FROM polling_unit 
WHERE lga_id = 13;
